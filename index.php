        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">USIU-A HEALTH CLINIC</div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:#fff; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Best Clinic Services in your town</div>
            ...
            <div class="tp-caption lfb tp-resizeme scroll" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="appointment.php" class="btn">Book Now</a> </div>
          </li>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:55px; font-weight:500; color:#000;  max-width: auto; max-height: auto; white-space: nowrap;">USIU-A HEALTH CLINIC</div>
      ...
      <div class="container">
        <div class="intro-main">
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                <h5>USIU-A HEALTH CLINIC</h5>
                <p>Besides providing world class clinical lab services, We have a pool of doctors of different medical specialty to serve the ailing patients as outpatients. They are all reputed and respected in their medical specialty for outstanding clinical management</p>
                <ul class="row">
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                    <p>We offer 24/7 support and emergency Response to our student and staffs.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>We have qualitied doctors With over 10 years Experience</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Make your Appointments online 24/7 hours with access </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>We offer counselling from out psychological department </p>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img-2.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Asso. Prof. Dr. Kanyi<span>Cardiology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img.jpg" alt="" >
                        <div class="name-doc">
                          <h6>John Kamau <span>Emergency Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
