                        ...
                        <div class="text-sec padding-right-0">
                            ...
                            <ul class="row">
                                <li class="col-sm-6">
                                    ...
                                    <p>We offe 24/7 support to our students and incase of an emergency, We don't Hesitate to respond</p>
                                </li>
                                <li class="col-sm-6">
                                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                                    <p>Our Doctors are qualified with over 5 years experience in field of Medicine,
                                        specialized doctors. </p>
                                </li>
                                <li class="col-sm-6">
                                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                                    <p>You can make bookings online,
                                        Technological support to our students in order to access our facilities </p>
                                </li>
                                <li class="col-sm-6">
                                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                                    <p>Free of charge counselling for our students,
                                        In order to ensure Quality and promoting healthy living. </p>
                                </li>
                            </ul>
                        </div>
                    </div>
